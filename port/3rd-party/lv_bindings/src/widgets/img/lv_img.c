...
static void lv_img_set_src_core(lv_obj_t * obj, const void * src);
static void lv_img_thread_unlock(void * ctx);
...
void lv_img_set_src(lv_obj_t * obj, const void * src)
{
    ...
    lv_mp_thread_lock();
    nlr_push_jump_callback(&lock_cleanup, lv_img_thread_unlock);
    lv_img_set_src_core(obj, src);
