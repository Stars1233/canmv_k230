...
class Encoder:
    ...
    def create(self):
        ...
        if (not self.init):
            ...
            aenc_chn_attr.sample_rate = self.sample_rate
            aenc_chn_attr.channels = self.channels
            aenc_chn_attr.bitrate = self.bitrate
...
class Decoder:
    ...
    def create(self):
        ...
        if (not self.init):
            ...
            adec_chn_attr.sample_rate = self.sample_rate
            adec_chn_attr.channels = self.channels
