        ...
        with ScopedTiming("display_draw",self.debug_mode >0):
            ...
            if dets:
                for i in range(len(dets[0])):
                    ...
                    pl.osd_img.draw_line(int(x1),int(y1),int(x2),int(y2),color=self.color_four[res[1][i]],thickness=4)
                    pl.osd_img.draw_line(int(x2),int(y2),int(x3),int(y3),color=self.color_four[res[1][i]],thickness=4)
                    pl.osd_img.draw_line(int(x3),int(y3),int(x4),int(y4),color=self.color_four[res[1][i]],thickness=4)
                    pl.osd_img.draw_line(int(x4),int(y4),int(x1),int(y1),color=self.color_four[res[1][i]],thickness=4)
                    pl.osd_img.draw_string_advanced(x1, y1,24,str(res[1][i]) , color=self.color_four[res[1][i]])
                    self.d[res[1][i]]+=1
                text=""
