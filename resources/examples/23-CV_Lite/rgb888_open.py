# ============================================================
# MicroPython 图像开运算测试代码（使用 cv_lite 扩展模块）
# Image Opening (Erode + Dilate) Test using cv_lite extension
# ============================================================
...
import cv_lite               # cv_lite 扩展模块（含开操作）/ AI CV extension (open function)
