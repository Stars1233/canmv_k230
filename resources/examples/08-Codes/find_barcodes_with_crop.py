...
CROP_WIDTH = DETECT_WIDTH * 3 // 2
CROP_HEIGHT = DETECT_HEIGHT * 3 // 2

# crop 1.5x detect window from sensor output, then scale to detect windows
...
try:
    ...
    sensor.set_framesize(width = DETECT_WIDTH, height = DETECT_HEIGHT, crop = ((sensor_width - CROP_WIDTH) // 2, (sensor_height - CROP_HEIGHT) // 2, CROP_WIDTH, CROP_HEIGHT))
